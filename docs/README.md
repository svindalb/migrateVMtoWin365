...
- Target selection uses the license-discovery logic: Enterprise SKU/child-plan configuration matching, service-plan lookup. Only Enterprise is retained. Flex, Frontline, shared, GPU, Business, Reserve, DR add-ons, unrelated and unresolved/contradictory SKUs are excluded. Exclusion applies to the entire SKU, including child plans.
